...
const Sidebar = ({role,loading}) => {
  ...
  return (
    <>
      ...
      <div className="w-60">
        <aside className="flex flex-col w-64 h-screen px-4 py-4 overflow-y-auto  border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900  bg-base-200 dark:border-gray-700">
        <Link
          to='/'
...
{/*            
            <nav>
              ...
              <Link
                className="flex items-center px-4 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
